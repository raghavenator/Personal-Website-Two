      ...
      <div>
        ...
        <div class="grid-container">
          <div class="item1">
            ...
            <table>
              <td class="description-image">
                <img src={require("./images/homenobacc.PNG")} height="200"></img>        
                <img src={require("./images/dcmap2grnnobacc.PNG")} height="200"></img>
                <img src={require("./images/tuliphardware.png")} height="200"></img>
              </td>
          ...
          <div class="item2">
            ...
            <table>
              <td class="description-image">
                <img src={require("./images/whatcanieat.PNG")} height="200"></img>        
                <img src={require("./images/whatcanieat2.PNG")} height="200"></img>
              </td>
              <td class="description-text">
          ...
          <div class="item3">
            ...
            <table>
              <td class="description-image">
                <img src={require("./images/mlbapphome.PNG")} height="200"></img>        
                <img src={require("./images/mlbappscore.PNG")} height="200"></img>
              </td>
              <td class="description-text">
          ...
          <div class="item4">
            ...
            <table>
              <td class="description-image">
                <img src={require("./images/website.PNG")} height="150"></img>
              </td>
              <td class="description-text">
